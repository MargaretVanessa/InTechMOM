const btnSubmit = document.getElementById("searchButton");
btnSubmit.addEventListener('click', getPokemon,);
const pokemonInput = document.getElementById("form-control");
const pokemonImg = document.getElementById("poke-img");
const pokemonCard = document.getElementById("descripcion");
